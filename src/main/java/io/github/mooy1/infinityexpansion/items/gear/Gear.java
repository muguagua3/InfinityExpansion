...
public final class Gear {
    ...
    public static void setup(InfinityExpansion plugin) {
        ...
        new InfinityArmor(CROWN, new PotionEffect[] {
                ...
                null, null, Materials.VOID_SINGULARITY, null, null, null
        }).register(plugin);
        new InfinityArmor(CHESTPLATE, new PotionEffect[] {
                ...
                null, Materials.INFINITE_INGOT, Materials.INFINITE_INGOT, Materials.INFINITE_INGOT, Materials.INFINITE_INGOT, null,
                Materials.VOID_SINGULARITY, Materials.INFINITE_INGOT, Materials.INFINITE_INGOT, Materials.INFINITE_INGOT, Materials.INFINITE_INGOT, null
        }).register(plugin);
        new InfinityArmor(LEGGINGS, new PotionEffect[] {
                ...
                Materials.VOID_INGOT, Materials.INFINITE_INGOT, null, null, Materials.INFINITE_INGOT, Materials.VOID_INGOT,
                Materials.VOID_INGOT, Materials.INFINITE_INGOT, null, null, Materials.INFINITE_INGOT, Materials.VOID_INGOT,
                null, Materials.INFINITE_INGOT, null, Materials.VOID_SINGULARITY, Materials.INFINITE_INGOT, null
        }).register(plugin);
        new InfinityArmor(BOOTS, new PotionEffect[] {
                ...
                Materials.INFINITE_INGOT, Materials.INFINITE_INGOT, null, null, Materials.INFINITE_INGOT, Materials.INFINITE_INGOT,
                Materials.INFINITE_INGOT, Materials.INFINITE_INGOT, Materials.VOID_SINGULARITY, null, Materials.INFINITE_INGOT, Materials.INFINITE_INGOT
        }).register(plugin);
        new InfinityTool(SHIELD, new ItemStack[] {
                ...
                null, Materials.INFINITE_INGOT, Materials.VOID_INGOT, Materials.VOID_INGOT, Materials.INFINITE_INGOT, Materials.VOID_SINGULARITY
        }).register(plugin);
        new InfinityBow(Groups.INFINITY_CHEAT, BOW, InfinityWorkbench.TYPE, new ItemStack[] {
                ...
                null, null, null, Materials.VOID_INGOT, Materials.INFINITE_INGOT, Materials.VOID_SINGULARITY
        }).register(plugin);
        new InfinityTool(AXE, new ItemStack[] {
                ...
                Materials.VOID_INGOT, null, Materials.VOID_SINGULARITY, null, Materials.VOID_INGOT, null
        }).register(plugin);
        new InfinityTool(BLADE, new ItemStack[] {
                ...
                Materials.VOID_INGOT, null, Materials.INFINITE_INGOT, Materials.VOID_SINGULARITY, null, null
        }).register(plugin);
        new InfinityTool(SHOVEL, new ItemStack[] {
                ...
                Materials.VOID_INGOT, null, null, Materials.VOID_SINGULARITY, null, null
        }).register(plugin);
        ...
        new InfinityMatrix(Groups.INFINITY_CHEAT, INFINITY_MATRIX, InfinityWorkbench.TYPE, new ItemStack[] {
                ...
                Materials.VOID_INGOT, Materials.VOID_INGOT, Materials.INFINITE_ALLOY, Materials.INFINITE_ALLOY, Materials.VOID_INGOT, Materials.VOID_INGOT,
                Materials.INFINITE_INGOT, Materials.VOID_INGOT, Materials.VOID_INGOT, Materials.VOID_INGOT, Materials.VOID_INGOT, Materials.INFINITE_INGOT,
                Materials.INFINITE_INGOT, Materials.VOID_SINGULARITY, Materials.INFINITE_INGOT, Materials.INFINITE_INGOT, Materials.VOID_SINGULARITY, Materials.INFINITE_INGOT
        }).register(plugin);
