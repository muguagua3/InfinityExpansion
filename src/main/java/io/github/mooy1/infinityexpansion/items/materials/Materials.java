...
public final class Materials {
    ...
    public static final SlimefunItemStack INFINITE_INGOT = new SlimefunItemStack(
         ...
         public static final SlimefunItemStack INFINITE_ALLOY = new SlimefunItemStack(
            "INFINITE_ALLOY",
            Material.IRON_INGOT,
            "&e无&a尽&b合&8金", // &dI&cn&6f&ei&an&bi&3t&9y &fIngot
            "&7&o真正的宇宙的力量掌握在你手中"
    );
    ...
    public static final SlimefunItemStack VOID_SINGULARITY = new SlimefunItemStack(
         ...
         public static final SlimefunItemStack GUA_SINGULARITY = new SlimefunItemStack(
            "GUA_SINGULARITY",
            Material.SMOOTH_QUARTZ,
            "&8瓜奇点"
    );
    ...
    public static void setup(InfinityExpansion plugin) {
        ...
        registerSmeltery(INFINITE_ALLOY, VOID_SINGULARITY, INFINITY_SINGULARITY, GUA_SINGULARITY, INFINITE_CORE, INFINITE_CIRCUIT, COBBLE_5);
        ...
        registerSmeltery(TITANIUM_ALLOY, VOID_INGOT,  COPPER_SINGULARITY, TITANIUM);
