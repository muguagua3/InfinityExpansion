    ...
    public static void setup(InfinityExpansion plugin) {
        ...
        new MobDataCard(ZOMBIE, MobDataTier.HOSTILE, new ItemStack[] {
         ...
         new MobDataCard(GHAST, MobDataTier.HOSTILE, new ItemStack[] {
                new ItemStack(Material.GHAST_TEAR, 64), new ItemStack(Material.FIRE_CHARGE, 16), new ItemStack(Material.GHAST_TEAR, 64),
                new ItemStack(Material.GUNPOWDER, 64), EMPTY_DATA_CARD, new ItemStack(Material.GUNPOWDER, 64),
                new ItemStack(Material.GHAST_TEAR, 64), new ItemStack(Material.FIRE_CHARGE, 16), new ItemStack(Material.GHAST_TEAR, 64)
        }).addDrop(Material.GUNPOWDER, 4).addDrop(Material.GHAST_TEAR, 2).register(plugin);
        ...
        new MobDataCard(SQUID, MobDataTier.PASSIVE, new ItemStack[] {
                new ItemStack(Material.INK_SAC, 16), new ItemStack(Material.COD, 16), new ItemStack(Material.INK_SAC, 16),
                new ItemStack(Material.BLACK_DYE, 64), EMPTY_DATA_CARD, new ItemStack(Material.BLACK_DYE, 64),
                new ItemStack(Material.INK_SAC, 16), new ItemStack(Material.COD, 16), new ItemStack(Material.INK_SAC, 16)
        }).addDrop(Material.INK_SAC, 8).addDrop(Material.GLOW_INK_SAC, 8).register(plugin);
        ...
        }).addDrop(Material.NETHER_STAR, 1, 2).addDrop(SlimefunItems.COMPRESSED_CARBON, 16, 1).register(plugin);
        ...
        }).addDrop(Materials.VOID_DUST, 4, 10).addDrop(Materials.ENDER_ESSENCE, 8, 20).addDrop(Material.DRAGON_EGG, 1_0000_0000).register(plugin);
